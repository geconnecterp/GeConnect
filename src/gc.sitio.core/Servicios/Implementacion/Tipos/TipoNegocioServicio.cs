        ...
        public List<TipoNegocioDto> ObtenerTiposDeNegocio(string token)
        {
            try
            {
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    apiResponse = JsonConvert.DeserializeObject<ApiResponse<List<TipoNegocioDto>>>(stringData) ?? throw new NegocioException("Hubo un problema al deserializar los datos");
