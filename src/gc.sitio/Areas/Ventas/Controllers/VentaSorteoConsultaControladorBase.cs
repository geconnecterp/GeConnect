...
{
	public class VentaSorteoConsultaControladorBase : ControladorBase
	{
		private readonly AppSettings _setting;
		public VentaSorteoConsultaControladorBase(IOptions<AppSettings> options, IHttpContextAccessor contexto, ILogger logger) : base(options, contexto, logger)
		{
