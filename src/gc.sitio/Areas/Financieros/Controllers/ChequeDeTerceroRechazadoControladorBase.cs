...
{
	public class ChequeDeTerceroRechazadoControladorBase : ControladorBase
	{
		private readonly AppSettings _setting;
		public ChequeDeTerceroRechazadoControladorBase(IOptions<AppSettings> options, IHttpContextAccessor accessor, ILogger logger) : base(options, accessor, logger)
		{
