...
{
	public class PedidoInternoConsultaControladorBase : ControladorBase
	{
		private readonly AppSettings _setting;
		public PedidoInternoConsultaControladorBase(IOptions<AppSettings> options, IHttpContextAccessor contexto, ILogger logger) : base(options, contexto, logger)
		{
