...
{
	[Area("Consultas")]
	public class ReporteEvoVtasPerAnterioresController : ReporteEvoVtasPerAnterioresControladorBase
	{
		...
		private string APP_MODULO = AppModulos.REPORTE_DE_EVOLUCION_DE_VENTAS_CON_PERIODO_ANTERIORES.ToString();
		private readonly IDocManagerServicio _docMSv;

		//************************
		public ReporteEvoVtasPerAnterioresController(IOptions<AppSettings> options,IHttpContextAccessor httpContextAccessor,ILogger<ReporteEvoVtasPerAnterioresController> logger,
													 ...
													 IDocManagerServicio docManager, IOptions<DocsManager> docsManager) : base(options, httpContextAccessor, logger)
		{
		...
		{
			var model = new ReporteEvoVtasPerAnterioresModel();
			try
			{
				...
				var titulo = "REPORTE DE EVOLUCIÓN DE VENTAS CON PERIODOS ANTERIORES";
		...
		public async Task<IActionResult> RepEvoVtasPerAnteriores(ReporteEvoVtasPerAnterioresRequest request)
		{
			var model = new ListadoEvoVtasPerAntModel();
			...
			try
			{
				...
				var res = _consultasServicio.RepEvoVtasPerAnteriores(request, TokenCookie);
				ListaProductoEvo = res;

				model.GrillaProductoEvo = ObtenerGridCoreSmart<ReporteEvoVtasPerAnterioresDto>(res);
		...
		private void CargarDatosIniciales(ReporteEvoVtasPerAnterioresModel model)
		{
