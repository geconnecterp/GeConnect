$(function () {
    ...
    $("#btnAbmCancelar").on("click", InicializaPantallaZona);
    $("#btnAbmAceptar").on("click", confirmarOperacionAbmZona);
...
function ejecutarAlta() {
    ...
    switch (tabAbm) {
        case 1:
            PostGenHtml(data, nuevoZonaUrl, function (obj) {
                $("#divpanel01").html(obj);
...
function buscarZona(data) {
    PostGenHtml(data, buscarZonaUrl, function (obj) {
        $("#divpanel01").html(obj);
        //se procede a buscar la grilla de barrado
...
function confirmarOperacionAbmZona() {
                ...
                switch (tabAbm) {
                    case 1:
                        if (accion !== AbmAction.BAJA) {
                            ...
                            InicializaFiltroAbmZona(EntidadSelect);
...
function InicializaFiltroAbmZona(id) {
...
function confirmarDatosTab01() {
    ...
    var zn_desc = $("#zn_desc").val();
   

    var data = { zn_id, zn_desc,accion };
    return data;
}