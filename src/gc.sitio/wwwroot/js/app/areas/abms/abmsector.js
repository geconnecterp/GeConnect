$(function () {
    ...
    $("#btnAbmAceptar").on("click", function () {
        posicionarRegEnGrid(function () { btnSubmitClick(); });
...
//hago que funcione ejecutando una función (callback)
function posicionarRegEnGrid(callback) {
...
function analizaEstadoBtnDetalle() {
    ...
    //nos posicionamos sobre el tab
    $("#btnTabSector").trigger("click");
    ...
    $("#" + Grids.GridSector + " tbody tr").removeClass("selectedEdit-row");
...
function buscarSectores(pag, esBaja = false, callback) {
    AbrirWaiting();
    var buscar = "";
    var id = "";
    var id2 = "";
