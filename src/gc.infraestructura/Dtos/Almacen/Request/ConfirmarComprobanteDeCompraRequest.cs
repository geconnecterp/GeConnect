...
namespace gc.infraestructura.Dtos.Almacen.Request
{
	...
	public class AgregarOPDRequest : ComprobanteDto
	{
		public string cm_compte_pto_vta { get; set; } = string.Empty;
		public string cm_compte_pto_nro { get; set; } = string.Empty;
	}

	public class ComprobanteDto : Dto
	{
		...
		public string ctag_desc { get; set; } = string.Empty;
