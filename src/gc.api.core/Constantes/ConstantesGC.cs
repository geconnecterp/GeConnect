namespace gc.api.core.Constantes
{
	public static class ConstantesGC
	{
		...
		public static class StoredProcedures
		{
			...
			public const string SP_AUTH_SOLICITUD_AUTORIZACION_PENDIENTES = "SPGECO_SAUTH_SOLICITUD_AUTORIZACION_PENDIENTES";
            public const string SP_AUTH_SOLICITUD_AUTORIZACION_HISTORICO = "SPGECO_SAUTH_SOLICITUD_AUTORIZACION_HISTORICO";
			public const string SP_AUTH_SOLICITUD_AUTORIZACION_BLOQUEAR = "SPGECO_SAUTH_SOLICITUD_AUTORIZACION_BLOQUEAR";
			public const string SP_AUTH_SOLICITUD_AUTORIZACION_CREAR = "SPGECO_SAUTH_SOLICITUD_AUTORIZACION_CREAR";
			public const string SP_AUTH_SOLICITUD_AUTORIZACION_RESOLVER = "SPGECO_SAUTH_SOLICITUD_AUTORIZACION_RESOLVER";
			public const string SP_AUTH_SOLICITUD_AUTORIZACION_OBTENER = "SPGECO_SAUTH_SOLICITUD_AUTORIZACION_OBTENER";
			public const string SP_AUTH_SOLICITUD_AUTORIZACION_OBTENER_EXPIRADAS = "SPGECO_SAUTH_SOLICITUD_AUTORIZACION_OBTENER_EXPIRADAS";
			public const string SP_AUTH_SOLICITUD_AUTORIZACION_EXPIRAR = "SPGECO_SAUTH_SOLICITUD_AUTORIZACION_EXPIRAR";
			public const string SP_AUTH_RESOLUCION_AUTORIZACION_HISTORICO = "SPGECO_SAUTH_RESOLUCION_AUTORIZACION_HISTORICO";
            public const string SP_SAUTH_BANDEJA_SALIDA_INSERTAR = "SPGECO_SAUTH_BANDEJA_SALIDA_INSERTAR";
            public const string SP_SAUTH_BANDEJA_SALIDA_OBTENER_PENDIENTES = "SPGECO_SAUTH_BANDEJA_SALIDA_OBTENER_PENDIENTES";
            public const string SP_SAUTH_BANDEJA_SALIDA_ACTUALIZAR = "SPGECO_SAUTH_BANDEJA_SALIDA_ACTUALIZAR";
			...
			public const string SP_SORTEOS_COMPTES = "SPGECO_Sorteos_Comptes";
			public const string SP_SORTEOS_ANALISIS_PROD= "SPGECO_Sorteos_Analisis_Productos";
			#endregion
			...
			public const string SP_PROV_MODIFICA_PRECIO = "SPGECO_P_PR_Prov_sin_Modificaciones";
			...
			public const string SP_AJ_LISTA = "dbo.SPGECO_AJ_Lista";
			...
			public const string SP_F_AN_ANULA_CONFIRMAR = "SPGECO_F_AN_Anula_Confirmar";
			...
			public const string SP_COMPTE_VALORIZA_AGREGAR_PRODUCTO = "SPGECO_Compte_Valoriza_Agragar_Producto";
			#region Asientos
			...
			public const string SP_PC_LISTA_2 = "SPGECO_PC_lista_2";
