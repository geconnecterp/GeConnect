...
namespace gc.api.core.Contratos.Servicios.LineaCaja
{
    public interface IApiCajaServicio
    {
        ...
        RespuestaDto CierreCajaConRendicion(CierreCajaRequestDto reqDto);
        List<CuentaBusquedaResultadoDto> BusquedaClientes(string busqueda, string adm_id, string usu_id, string app);
