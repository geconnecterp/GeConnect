...
{
    public class ABMClienteServicio : Servicio<Cuenta>, IABMClienteServicio
    {
        public ABMClienteServicio(IUnitOfWork uow, IOptions<PaginationOptions> pag) : base(uow, pag)
        {
        }

        public List<ABMClienteSearchDto> Buscar(QueryFilters filtros)
        {
            ...
            List<ABMClienteSearchDto> cliente = _repository.EjecutarLstSpExt<ABMClienteSearchDto>(sp, ps, true);
