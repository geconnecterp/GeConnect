...
{
	public class R027_VencimientoChequesEmitidos : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R027_VencimientoChequesEmitidos(IUnitOfWork uow, IConsultaServicio consulta, IFinancieroServicio financieroServicio,
		...
		private List<FinancieroBcoVencChequeEmitidoListaDto> ObtenerDatos(ReporteSolicitudDto solicitud, out string titulo, out string subTitulo, out string fDesdePrint, out string fHastaPrint)
		{
			...
			titulo = $"Cheques Emitidos\ncon Vto. desde el {fDesdePrint} al {fHastaPrint}";
