...
{
	public class R034_ProyeccionDeIngreso : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R034_ProyeccionDeIngreso(IUnitOfWork uow, IConsultaServicio consulta, IFinancieroServicio financieroServicio,
		...
		public string Generar(ReporteSolicitudDto solicitud)
		{
			...
			try
			{
				...
				string tit;
				List<ProyFinanDto> registros = ObtenerDatos(solicitud, out tit);
				...
				#region Encabezados y totales
				HelperPdf.AgregarEncabezadoFinanciero(pdf, registros.First(), chico, normalBold);
				#endregion

				#region Lista Proyeccion financiera
				HelperPdf.CargarTablaProyeccionFinanciera(pdf, registros, chico, normalBold);
				#endregion
		...
		private List<ProyFinanDto> ObtenerDatos(ReporteSolicitudDto solicitud, out string titulo)
		{
			...
			return _financieroServicio.GetProyeccionFinanciera(new BuscarProyFinanRequest() 
			{ 
