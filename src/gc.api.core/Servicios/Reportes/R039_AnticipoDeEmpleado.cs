...
{
	public class R039_AnticipoDeEmpleado : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R039_AnticipoDeEmpleado(IUnitOfWork uow, IConsultaServicio consulta, IFinancieroServicio financieroServicio,
		...
		public string Generar(ReporteSolicitudDto solicitud)
		{
			...
			try
			{
				...
				List<AnticipoDetalleDto> registros = ObtenerDatos(solicitud);
				...
				HelperPdf.CargarAnticiposDeEmpleados(pdf, registros, chico, normalBold, _empresaGeco, solicitud);
				#endregion
		...
		private List<AnticipoDetalleDto> ObtenerDatos(ReporteSolicitudDto solicitud)
		{
