...
{
	public class R026_ConsultaDeMovimientoFinanciero : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R026_ConsultaDeMovimientoFinanciero(IUnitOfWork uow, IConsultaServicio consulta, IFinancieroServicio financieroServicio,
