...
{
	public class R027_TransferenciaEntreLiquidacion : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R027_TransferenciaEntreLiquidacion(IUnitOfWork uow, IConsultaServicio consulta, IOrdenDePagoServicio ordenDePagoServicio,
