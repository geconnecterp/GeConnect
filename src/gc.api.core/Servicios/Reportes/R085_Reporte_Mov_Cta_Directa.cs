...
{
	public class R085_Reporte_Mov_Cta_Directa : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R085_Reporte_Mov_Cta_Directa(IUnitOfWork uow, IConsultaServicio consSrv,
