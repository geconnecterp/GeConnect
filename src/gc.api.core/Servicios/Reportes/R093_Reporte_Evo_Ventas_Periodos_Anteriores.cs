...
{
	public class R093_Reporte_Evo_Ventas_Periodos_Anteriores : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R093_Reporte_Evo_Ventas_Periodos_Anteriores(IUnitOfWork uow, IConsultaServicio consSrv,
