...
{
	public class R025_TransferenciaEntreCuentas_BA_CA : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R025_TransferenciaEntreCuentas_BA_CA(IUnitOfWork uow, IConsultaServicio consulta, IFinancieroServicio finSrv,
