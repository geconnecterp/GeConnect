...
{
	public class R024_ConsultaDeOrdenesDePago : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R024_ConsultaDeOrdenesDePago(IUnitOfWork uow, IConsultaServicio consulta, IOrdenDePagoServicio ordenDePagoServicio,
