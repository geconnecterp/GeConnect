...
{
	public class R030_HistoricoLibro : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R030_HistoricoLibro(IUnitOfWork uow, IConsultaServicio consulta, IFinancieroServicio financieroServicio,
		...
		public string Generar(ReporteSolicitudDto solicitud)
		{
			...
			{
				_logger.LogError(ex, "Error en R030");
				throw new NegocioException("Se produjo un error al intentar generar el Reporte de Historico Libro. Para mayores datos ver el log.");
			}
		}
