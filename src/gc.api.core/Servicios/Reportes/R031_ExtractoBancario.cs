...
{
	public class R031_ExtractoBancario : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R031_ExtractoBancario(IUnitOfWork uow, IConsultaServicio consulta, IFinancieroServicio financieroServicio,
