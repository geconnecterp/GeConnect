...
{
	public class R023_OrdenDePagoDirecta : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R023_OrdenDePagoDirecta(IUnitOfWork uow, IConsultaServicio consulta,
		...
		public string Generar(ReporteSolicitudDto solicitud)
		{
			...
			try
			{
				...
				if (solicitud.Cuenta != null && solicitud.Cuenta.Cta_Id != "")
					HelperPdf.CargarTablaProveedor(pdf, solicitud.Cuenta, normal, normalBold);
				#endregion
		...
		private List<ConsOrdPagoDetExtendDto> ObtenerDatos(ReporteSolicitudDto solicitud, out string ctaId, out string titulo)
		{
			...
			titulo = $"Orden de Pago Directa N° {cmptId}";
