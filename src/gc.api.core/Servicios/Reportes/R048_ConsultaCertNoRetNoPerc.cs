...
{
	public class R048_ConsultaCertNoRetNoPerc : Servicio<EntidadBase>, IGeneradorReporte
	{
		...
		public R048_ConsultaCertNoRetNoPerc(IUnitOfWork uow, IConsultaServicio consulta, IFinancieroServicio financieroServicio,
